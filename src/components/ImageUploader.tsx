...
export default function ImageUploader() {
  ...
  return (
    <div className="max-w-[90vw] lg:max-w-[80vw] mx-auto">
      <h1 className="font-sans text-quaternary font-semibold my-6 text-[1.6rem] lg:w-[70vw] max-w-[1250px] mx-3 lg:leading-snug md:text-3xl lg:text-3xl md:my-8 pt-2 lg:mt-14 text-center">
      ...
      <div>
        {!model ? (
          ...
          <div className="flex flex-col justify-center items-center my-2 lg:my-16 fade-in">
